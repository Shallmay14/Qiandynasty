...
(
	...
	'trade_finished' => '<font color="green">交易成功\結束</font>',
	...
	'perms_allowsetattachperm' => '允許\設置附件權限',
	...
	'perms_allowpoke' => '允許\打招呼',
	'perms_allowfriend' => '允許\加好友',
	'perms_allowclick' => '允許\表態',
	'perms_allowmyop' => '允許\使用應用',
	'perms_allowcomment' => '發表留言/評論',
	'perms_allowstatdata' => '查看統計數據報表',
	'perms_allowstat' => '允許\查看趨勢統計',
	'perms_allowpostarticle' => '發表文章',
	'perms_raterange' => '允許\參與評分',
	'perms_allowcommentpost' => '允許\參與點評',
	'perms_allowat' => '允許\ @ 的人數',
	'perms_allowreplycredit' => '允許\設置回帖獎勵',
	'perms_allowposttag' => '允許\使用標籤',
	'perms_allowcreatecollection' => '允許\創建淘專輯的數量',
	'perms_allowsendpm' => '允許\發短消息',
	'perms_maximagesize' => '單張圖片最大尺寸',
	'perms_allowmediacode' => '允許\使用多媒體代碼',
