...
(
	...
	'optimizer_setting_cache_index_desc' => '開啟此功\能可減輕服務器負載',
	'optimizer_setting_cache_optimize_desc' => '設置緩存時間為900秒',
	'optimizer_setting_cache_post' => '緩存帖子',
	'optimizer_setting_cache_post_desc' => '開啟此功\能可減輕服務器負載',
	'optimizer_setting_cache_post_optimize_desc' => '設置緩存時間為900秒',
	'optimizer_setting_optimizeviews' => '優化更新主題瀏覽量',
	'optimizer_setting_optimizeviews_desc' => '開啟此功\能可減輕更新主題瀏覽量時對服務器產生的負載',
	'optimizer_setting_optimizeviews_optimize_desc' => '開啟此功\能',
	'optimizer_setting_delayviewcount' => '附件下載量延遲更新',
	'optimizer_setting_delayviewcount_desc' => '延遲更新附件的瀏覽量，可明顯降低訪問量很大的站點的服務器負擔',
	'optimizer_setting_delayviewcount_optimize_desc' => '開啟此功\能',
	'optimizer_setting_preventrefresh' => '查看數開啟防刷新',
	'optimizer_setting_preventrefresh_desc' => '開啟防刷新，可明顯降低服務器壓力',
	'optimizer_setting_preventrefresh_optimize_desc' => '開啟此功\能',
	'optimizer_setting_nocacheheaders' => '禁止瀏覽器緩衝',
	'optimizer_setting_nocacheheaders_desc' => '可用於解決極個別瀏覽器內容刷新不正常的問題，本功\能會加重服務器負擔',
	'optimizer_setting_nocacheheaders_optimize_desc' => '關閉此功\能',
	...
	'optimizer_setting_lazyload_optimize_desc' => '開啟此功\能',
	'optimizer_setting_sessionclose' => '關閉session機制',
	'optimizer_setting_sessionclose_desc' => '關閉session機制以後，可明顯降低站點的服務器負擔，建議在線用戶數超過2萬時開啟本功\能<br>注意：遊客數和用戶的在線時長將不再進行統計，論壇首頁和版塊列表頁面的在線用戶列表功\能將不可用',
	'optimizer_setting_sessionclose_optimize_desc' => '開啟此功\能',
	...
	'optimizer_setting_rewriteguest_desc' => '開啟此項，則 Rewrite功\能只對遊客和搜索引擎有效，可減輕服務器負擔',
	'optimizer_setting_rewriteguest_optimize_desc' => '開啟此功\能',
);
?>