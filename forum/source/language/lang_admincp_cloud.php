...
(
	...
	'cloud_select' => '請選擇',
	'cloud_agree_protocal' => '我已仔細閱\讀並同意',
	...
	'cloud_siteinfo_tips' => '<li>如果站點名稱或者站點URL有變動，請點擊「同步站點信息」按鈕。</li><li>站點KEY是站點與雲平台通信的驗證密鑰，若近期有危險操作洩漏站點KEY等信息，請點擊「更換站點KEY」按鈕。<span style="color:red;">請謹慎使用此功\能。</span></li>',

	'cloud_doctor_normal' => '正常',
	'cloud_doctor_tips' => '<li>Discuz!雲平台診斷工具是幫助您分析站點上的狀況，是否能與雲平台正常通信等功\能。</li><li>站點ID是您的站點在雲平台的唯一標識，請勿和其他站點共用一套站點ID和站點通信KEY</li>',
	...
	'cloud_search_tips' => '<li>開啟漫遊搜索功\能後，用戶可以使用基於漫遊的搜索功\能。</li>',
	...
	'setting_manyou_base_close_prompt_comment' => '您的站點開啟了漫遊應用多應用服務後，當平台有了新的信息的時候漫遊應用會自動提示給管理員。關閉本功\能後，您將不再獲取更新提示。',
	...
	'connect_setting_t_reply' => '允許\微博評論和轉播內容回流',
	'connect_setting_t_reply_comment' => '推送主題或分享主題到騰訊微博後，是否允許\微博評論和轉播內容回流',
	...
	'connect_setting_qshare_allow' => '開啟Q-Share功\能',
	...
	'qqgroup_msg_save_succeed' => '恭喜，信息成功\推送到QQ群',
	...
	'qqgroup_usergroup_feed_list' => '允許\推送的用戶組',
	'qqgroup_usergroup_feed_list_comment' => '所選用戶組擁有推送權限，可以按住 CTRL 多選',
	'qqgroup_setting_tips' => '<li>主題查看頁的「推送到QQ群」功\能，可將帖子即時推送到QQ群聊天框。</li><li><img src="static/image/admincp/cloud/feed.png" align="left"></li>',
	...
	'security_safe_login_open' => '開啟安全登陸功\能',
	...
	'search_setting_allow_thread_related_comment' => '展示在主題帖下方，根據帖子內容計算出站內相關的帖子，挖掘相似主題，拓展用戶閱\讀深度。',
