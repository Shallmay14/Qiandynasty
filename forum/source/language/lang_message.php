...
$lang = array (
  ...
  'credits_transaction_disabled' => '抱歉，交易積分尚未啟用，無法使用此功\能',
  ...
  'group_status_off' => '抱歉，{_G/setting/navs/3/navname}功\能尚未開啟',
  'thread_nopermission' => '抱歉，本帖要求閱\讀權限高於 {readperm} 才能瀏覽',
  ...
  'magics_nopermission' => '抱歉，您所在的用戶組不允許\使用道具',
  ...
  'home_status_off' => '抱歉，家園功\能尚未開啟',
  'space_has_been_locked' => '空間已被鎖定無法訪問，如有疑問請聯繫管理員',
  'activate_illegal' => '您所用的 ID 不存在或您不是等待驗證會員',
  'getpasswd_account_notmatch' => '抱歉，您填寫的賬戶資料不匹配，不能使用取回密碼功\能，如有疑問請與管理員聯繫',
  ...
  'ranklist_this_status_off' => '此排行功\能已關閉',
  ...
  'portal_nopermission' => '抱歉，您沒有權限使用門戶管理功\能',
  ...
  'action_closed' => '抱歉，站點尚未開啟此功\能或此功\能已被管理員禁止',
  'credits_addfunds_ctrl' => '抱歉，您兩次提交訂單間隔過小',
  'credits_addfunds_toomuch' => '抱歉，您超出本月允許\購買 {ec_maxcreditspermonth} 的限額',
  ...
  'trade_credit_invalid' => '抱歉，管理員已關閉積分交易功\能',
  ...
  'no_open_videophoto' => '站點已關閉視頻認證功\能',
  'admin_nopermission' => '抱歉，您沒有權限使用管理功\能',
  ...
  'user_banned' => '抱歉，您的 IP 地址不在允許\範圍內，或您的賬號被禁用，無法訪問本站點',
  ...
  'portal_status_off' => '抱歉，門戶功\能尚未開啟',
  ...
  'no_invitation_code' => '抱歉，邀請碼為空請填寫，沒有邀請碼不允許\註冊',
  'wrong_invitation_code' => '抱歉，邀請碼錯誤，請重新填寫，沒有邀請碼不允許\註冊',
  ...
  'group_join_succeed' => '成功\加入該{_G/setting/navs/3/navname}',
  'group_join_apply_succeed' => '成功\申請加入該{_G/setting/navs/3/navname}',
  'group_exit_founder' => '抱歉，{_G/setting/navs/3/navname}創始人不能退出{_G/setting/navs/3/navname}',
  'group_exit_succeed' => '已經成功\退出{_G/setting/navs/3/navname}',
  ...
  'group_level_cannot_do' => '抱歉，目前您的{_G/setting/navs/3/navname}等級沒有此功\能',
  ...
  'postappend_not_open' => '抱歉，站點沒有開啟帖子補充功\能',
  ...
  'trade_displayorder_updated' => '櫃台商品擺\放順序已更新',
  ...
  'not_open_invite' => '抱歉，本站目前暫時不允許\用戶通過邀請鏈接註冊',
  ...
  'task_grouplimit' => '抱歉，您所在的用戶組不允許\申請此任務',
  ...
  'task_completed' => '恭喜您，任務已成功\完成，您將收到獎勵通知，請注意查收',
  'task_giveup' => '您已放棄此任務',

  'activate_succeed' => '您好，{username}，您的帳號已被成功\激活，現在將轉入站點首頁',
  ...
  'lostpasswd_email_not_exist' => '抱歉，使用此 Email 的用戶不存在，不能使用取回密碼功\能',
  'lostpasswd_many_users_use_email' => '抱歉，存在多個使用此 Email 的用戶，請填寫您需要找回密碼的用戶名',
  'getpasswd_account_invalid' => '抱歉，創始人、受保護用戶、擁有站點設置權限的用戶不能使用取回密碼功\能',
  ...
  'imagepreview_errorcode_-4' => '服務器缺少處理圖片所需的功\能，無法處理',
  ...
  'collection_comment_closed' => '抱歉，管理員沒有開放淘專輯的評論功\能',
  'collection_comment_succ' => '發表評論成功\',
  'collection_comment_remove_succ' => '評論成功\刪除',
  'collection_recommend_url' => '請填寫主題地址',
  'collection_recommend_succ' => '已經成功\向淘專輯作者發送了推薦消息',
  ...
  'collection_follow_succ' => '成功\訂閱\淘專輯',
  'collection_unfollow_succ' => '成功\取消訂閱\淘專輯',
  ...
  'not_open_updatestat' => '站點尚未開啟趨勢統計功\能',
  ...
  'members_edit_succeed' => '用戶信息成功\更新，請繼續操作',
  'modcp_member_ban_illegal' => '您不能直接禁止該用戶',
  'modcp_member_ban_succeed' => '用戶資料成功\更新',
  ...
  'post_edit_nopermission_threadplign' => '抱歉，您沒有權限編輯本帖子或特殊帖功\能已關閉',
  ...
  'post_edit_thread_ban_del' => '抱歉，編輯帖子時不允許\刪除帖子',
  ...
  'extcredits_disallowexchangeout' => '{credittitle} 不允許\兌出',
  'extcredits_disallowexchangein' => '{credittitle} 不允許\兌入',
  ...
  'eccredit_reexplanation_closed' => '抱歉，允許\解釋的有效期已過',
  ...
  'no_privilege_sendmailday' => '抱歉，本站尚未開啟郵件提醒功\能',
  ...
  'do_success_thread_share_mod' => '您的分享成功\了，回復請等待管理員審核通過',
  ...
  'forum_archiver_disabled' => '抱歉，論壇 Archiver 功\能尚未開啟',
  ...
  'length_is_not_within_the_scope_of' => '抱歉，分頁數不在允許\的範圍內',
  ...
  'comment_comment_notallowed' => '該文章不允許\評論',
  ...
  'not_open_registration_invite' => '抱歉，本站目前暫時不允許\用戶直接註冊，需要有效的邀請碼才能註冊',
