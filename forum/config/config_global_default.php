...
// 是否啟用 X-Sendfile 功\能（需要服務器支持）0=close 1=nginx 2=lighttpd 3=apache
...
// 頁面輸出設置
$_config['output']['charset'] 			= 'big5';	// 頁面字符集
...
$_config['admincp']['runquery']			= 0;		// 是否允許\後台運行 SQL 語句 1=是 0=否[安全]
$_config['admincp']['dbimport']			= 1;		// 是否允許\後台恢復論壇數據  1=是 0=否[安全]
