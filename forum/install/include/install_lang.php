...
$lang = array(
	...
	'advice_gethostbyname' => '是否 PHP 配置中禁止了 gethostbyname 函數。請聯繫空間商，確定開啟了此項功\能',
	'advice_file_get_contents' => '該函數需要 php.ini 中 allow_url_fopen 選項開啟。請聯繫空間商，確定開啟了此項功\能',
	'advice_xml_parser_create' => '該函數需要 PHP 支持 XML。請聯繫空間商，確定開啟了此項功\能',
	'advice_fsockopen' => '該函數需要 php.ini 中 allow_url_fopen 選項開啟。請聯繫空間商，確定開啟了此項功\能',
	'advice_pfsockopen' => '該函數需要 php.ini 中 allow_url_fopen 選項開啟。請聯繫空間商，確定開啟了此項功\能',
	...
	'install_cloud' => '安裝成功\，歡迎開通Discuz!雲平台<br>Discuz!雲平台致力於幫助站長提高網站流量，增強網站運營能力，增加網站收入。<br>Discuz!雲平台目前免費提供了QQ互聯、騰訊分析、縱橫搜索、漫遊應用、SOSO表情服務。Discuz!雲平台將陸續提供更多優質服務項目。<br>開通Discuz!平台之前，請確保您的網站（Discuz!、UCHome或SupeSite）已經升級到Discuz! X3。',
...
<p>用戶須知：本協議是您與康盛公司之間關於您使用康盛公司提供的各種軟件產品及服務的法律協議。無論您是個人或組織、盈利與否、用途如何（包括以學習和研究為目的），均需仔細閱\讀本協議，包括免除或者限制康盛責任的免責條款及對您的權利限制。請您審閱\並接受或不接受本服務條款。如您不同意本服務條款及/或康盛隨時對其的修改，您應不使用或主動取消康盛公司提供的康盛產品。否則，您的任何對康盛產品中的相關服務的註冊、登陸、下載、查看等使用行為將被視為您對本服務條款全部的完全接受，包括接受康盛對服務條款隨時所做的任何修改。
<p>本服務條款一旦發生變更, 康盛將在網頁上公佈修改內容。修改後的服務條款一旦在網站管理後台上公佈即有效代替原來的服務條款。您可隨時登陸康盛官方論壇查閱\最新版服務條款。如果您選擇接受本條款，即表示您同意接受協議各項條件的約束。如果您不同意本服務條款，則不能獲得使用本服務的權利。您若有違反本條款規定，康盛公司有權隨時中止或終止您對康盛產品的使用資格並保留追究相關法律責任的權利。</p>
<p>在理解、同意、並遵守本協議的全部條款後，方可開始使用康盛產品。您可能與康盛公司直接簽訂另一書面協議，以補充或者取代本協議的全部或者任何部分。</p></p>

<p>康盛擁有本軟件的全部知識產權。本軟件只供許\可協議，並非出售。康盛只允許\您在遵守本協議各項條款的情況下複製、下載、安裝、使用或者以其他方式受益於本軟件的功\能或者知識產權。</p>

<h3>I. 協議許\可的權利</h3>
<ol>
   <li>您可以在完全遵守本許\可協議的基礎上，將本軟件應用於非商業用途，而不必支付軟件版權許\可費用。</li>
   ...
   <li>若您需將康盛軟件或服務用戶商業用途，必須另行獲得康盛的書面許\可，您在獲得商業授權之後，您可以將本軟件應用於商業用途，同時依據所購買的授權類型中確定的技術支持期限、技術支持方式和技術支持內容，自購買時刻起，在技術支持期限內擁有通過指定的方式獲得指定範圍內的技術支持服務。商業授權用戶享有反映和提出意見的權力，相關意見將被作為首要考慮，但沒有一定被採納的承諾或保證。</li>
...
<ol>
   ...
   <li>不得對本軟件或與之關聯的商業授權進行出租、出售、抵押或發放子許\可證。</li>
   <li>無論如何，即無論用途如何、是否經過修改或美化、修改程度如何，只要使用康盛產品的整體或任何部分，未經書面許\可，頁面頁腳處的康盛產品名稱和康盛公司下屬網站（http://www.comsenz.com、或 http://www.discuz.net） 的鏈接都必須保留，而不能清除或修改。</li>
   <li>禁止在康盛產品的整體或任何部分基礎上以發展任何派生版本、修改版本或第三方版本用於重新分發。</li>
   <li>您從應用中心下載的應用程序，未經應用程序開發者/所有者的書面許\可，不得對其進行反向工程、反向彙編、反向編譯等，不得擅自複製、修改、鏈接、轉載、彙編、發表、出版、發展與之有關的衍生產品、作品等。</li>
   <li>如果您未能遵守本協議的條款，您的授權將被終止，所許\可的權利將被收回，同時您應承擔相應法律責任。</li>
</ol>
...
<p>一旦您開始安裝康盛產品，即被視為完全理解並接受本協議的各項條款，在享有上述條款授予的權利的同時，受到相關的約束和限制。協議許\可範圍以外的行為，將直接違反本授權協議並構成侵權，我們有權隨時終止授權，責令停止損害，並保留追究相關責任的權力。</p>

<p>本許\可協議條款的解釋，效力及糾紛的解決，適用於中華人民共和國大陸法律。</p>
...
<p align="right">康盛公司</p>
	...
	'advice_fopen' => '該函數需要 php.ini 中 allow_url_fopen 選項開啟。請聯繫空間商，確定開啟了此項功\能',
	'advice_file_get_contents' => '該函數需要 php.ini 中 allow_url_fopen 選項開啟。請聯繫空間商，確定開啟了此項功\能',
	'advice_xml' => '該函數需要 PHP 支持 XML。請聯繫空間商，確定開啟了此項功\能',
	'none' => '無',
