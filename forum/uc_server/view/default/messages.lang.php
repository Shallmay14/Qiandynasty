...
$lang = array(
	...
	'pm_send_succeed' => '短消息成功\發送',
	'pm_send_announce_succeed' => '公共消息成功\發送',
	'pm_send_ignore' => '短消息發送失敗',
	'pm_delete_succeed' => '短消息成功\刪除',
	...
	'db_export_multivol_redirect' => '分卷備份: 數據文件 #$volume 成功\創建，程序將自動繼續。',
	'db_export_multivol_succeed' => '恭喜您，全部備份文件成功\創建，備份完成。',
	'db_import_multivol_succeed' => '分卷數據成功\導入數據庫。',
	'db_import_file_illegal' => '數據文件不存在: 可能服務器不允許\上傳文件或尺寸超過限制。',
	'db_import_multivol_redirect' => '分卷數據 #$volume 成功\導入數據庫，程序將自動導入本次備份的其他分卷。',
	...
	'syncappcredits_updated' => '成功\同步應用的積分設置',
