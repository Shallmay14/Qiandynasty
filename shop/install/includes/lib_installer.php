 ...
 * ============================================================================
 * $Author: liuhui $
 * $Id: lib_installer.php 17062 2010-03-25 06:25:22Z liuhui $
 */
 ...
 *
 * @access  public
 * @return  string     返回版本號，可能的值為0，1，2
 */
 ...
 *
 * @access  public
 * @param   array     $file_types        文件路徑數組，形如array('dwt'=>'', 'lbi'=>'', 'dat'=>'')
 * @return  string    全部可寫返回空串，否則返回以逗號分隔的文件類型組成的消息串
 */
 ...
 *
 * @access  public
 * @param   string      $db_host        主機
 * @param   string      $db_port        端口號
 * @param   string      $db_user        用戶名
 * @param   string      $db_pass        密碼
 * @return  mixed       成功返回數據庫列表組成的數組，失敗返回false
 */
 ...
 *
 * @access  public
 * @return  string     返回時區串，形如Asia/Shanghai
 */
 ...
 *
 * @access  public
 * @param   string      $conn                      數據庫連接
 * @param   string      $mysql_version        mysql版本號
 * @return  void
 */
 ...
 * @param   string      $db_host        主機
 * @param   string      $db_port        端口號
 * @return  string      host、port重組後的串，形如host:port
 */
 ...
 *
 * @access  public
 * @param   array         $sql_files        SQL文件路徑組成的數組
 * @return  boolean       成功返回true，失敗返回false
 */
 ...
 *
 * @access  public
 * @param   array      $goods_types     預選商品類型
 ...
 *
 * @access  public
 * @param   string      $system_lang            系統語言
 * @param   string      $disable_captcha        是否開啟驗證碼
 * @param   array       $goods_types            預選商品類型
 * @param   string      $install_demo           是否安裝測試數據
 * @param   string      $integrate_code         用戶接口
 * @return  boolean     成功返回true，失敗返回false
 */
