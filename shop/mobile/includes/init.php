...
{
    echo "<meta http-equiv='Content-Type' content='text/html; charset=utf-8' /><title>ECShop_mobile</title></head><body><p align='left'>對不起,{$_CFG['shop_name']}暫時沒有開啟手機購物功能</p></body></html>";
    exit();
}
