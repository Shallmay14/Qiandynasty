...
class cls_template
{
    ...
    var $cache_dir      = '';
    var $compile_dir    = '';
    var $cache_lifetime = 3600; // 緩存更新時間, 默認 3600 秒
    ...
    var $_temp_key      = array();  // 臨時存放 foreach 裡 key 的數組
    var $_temp_val      = array();  // 臨時存放 foreach 裡 item 的數組
    ...
    function smarty_prefilter_preCompile($source)
    {
        ...
        $tmp_dir   = 'themes/' . $GLOBALS['_CFG']['template'] . '/'; // 模板所在路徑
