...
$payment_lang = ROOT_PATH . 'languages/' .$GLOBALS['_CFG']['lang']. '/payment/openpay_ibon.php';
...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    $modules[$i]['desc']    = 'openpay_ibon_desc';
    $modules[$i]['is_cod']  = '0';
    ...
    $modules[$i]['config'] = array(
        array('name' => 'openpay_ibon_mid',  'type' => 'text', 'value' => 'TEST'),
        array('name' => 'openpay_ibon_key1', 'type' => 'text', 'value' => '21216879a5d9e1c51b3cbc1c68b22399'),
        array('name' => 'openpay_ibon_key2', 'type' => 'text', 'value' => '6d4b111610073f9c1105d3f852a3d039')
    );
...
class openpay_ibon
{
    ...
    {
        $mid        = $payment['openpay_ibon_mid'];
        $key1       = $payment['openpay_ibon_key1'];
        $key2       = $payment['openpay_ibon_key2'];
        ...
        $pay_url  = "\n"
          ...
          ."<input type='submit' value='".$GLOBALS['_LANG']['openpay_ibon_button']."' />\n"
          ."</form>\n";
