...
$payment_lang = ROOT_PATH . 'languages/' .$GLOBALS['_CFG']['lang']. '/payment/openpay_vaccount.php';
...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    $modules[$i]['desc']    = 'openpay_vaccount_desc';
    $modules[$i]['is_cod']  = '0';
    ...
    $modules[$i]['config'] = array(
        array('name' => 'openpay_vaccount_mid',  'type' => 'text', 'value' => 'TEST'),
        array('name' => 'openpay_vaccount_key1', 'type' => 'text', 'value' => '21216879a5d9e1c51b3cbc1c68b22399'),
        array('name' => 'openpay_vaccount_key2', 'type' => 'text', 'value' => '6d4b111610073f9c1105d3f852a3d039')
    );

    return;
}

class openpay_vaccount
{
    function openpay_vaccount()
    {
        $this->form_action_url  = 'https://www.twv.com.tw/openpay/pay.php';
        $this->version          = '2.1';
        $this->prefer_paymethod = '2';
        $this->iid              = '0';
        $this->charset          = 'UTF-8';
    ...
    {
        $this->openpay_vaccount();
    }

    function get_code($order, $payment)
    {
        $mid        = $payment['openpay_vaccount_mid'];
        $key1       = $payment['openpay_vaccount_key1'];
        $key2       = $payment['openpay_vaccount_key2'];
        ...
        $pay_url  = "\n"
          ...
          ."<input type='submit' value='".$GLOBALS['_LANG']['openpay_vaccount_button']."' />\n"
          ."</form>\n";
