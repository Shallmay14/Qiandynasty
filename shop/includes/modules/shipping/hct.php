 ...
 * $Id: hct.php 3819 2006-12-28 07:10:34Z paulgao $
*/
	
$shipping_lang = ROOT_PATH.'languages/' .$GLOBALS['_CFG']['lang']. '/shipping/hct.php';
...
class hct
{
    ...
    {
        $form_str = '商品透過新竹貨運發出<br>您的宅配單號如下<form name="frmhct" method="post" target=_blank action="http://cagweb01.hct.com.tw/pls/cagweb/C_POKAM031_NEW_S?pSearchFlg=2" >';
        $form_str .= '<input name="pKey" type="hidden" value='.$invoice_sn.'>';
