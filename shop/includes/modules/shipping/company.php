 ...
 * $Id: company.php 3819 2006-12-28 07:10:34Z paulgao $
*/

$shipping_lang = ROOT_PATH.'languages/' .$GLOBALS['_CFG']['lang']. '/shipping/company.php';
...
if(isset($set_modules) && $set_modules == TRUE) 
{
    ...
    /* 配送方式插件的代码必须和文件名保持一致 */
    $modules[$i]['code']    = "company";
    
    $modules[$i]['version'] = '1.0.0';
    
    /* 配送方式的描述 */
    $modules[$i]['desc']    = 'company_desc';
