 ...
 * $Id: tjoinday.php 3819 2006-12-28 07:10:34Z paulgao $
*/
$shipping_lang = ROOT_PATH.'languages/' .$GLOBALS['_CFG']['lang']. '/shipping/tjoinday.php';
...
if(isset($set_modules) && $set_modules == TRUE) 
{
    ...
    /* 配送方式插件的代码必须和文件名保持一致 */
    $modules[$i]['code']    = "tjoinday";
    
    $modules[$i]['version'] = '1.0.0';
    
    /* 配送方式的描述 */
    $modules[$i]['desc']    = 'tjoinday_desc';
...
class tjoinday
{
    ...
    {
        $form_str = '商品透過大榮貨運一日配發出<br>您的宅配單號如下<form name="frmtjoinday" method="post" target=_blank action="http://www.tjoinday.com/query/webquery2/queryc2-1.asp" >';
