...
$_LANG['shop_register_closed'] = '該商店暫停註冊';
...
$_LANG['tag_cloud_desc'] = '標籤雲（Tag cloud）是用以表示一個網站中的內容標籤。 標籤（tag、關鍵詞）是一種更為靈活、有趣的商品分類方式，您可以為每個商品加入一個或多個標籤，那麼可以透過點選這個標籤檢視商品其它會員送出的與您的標籤一樣的商品,能夠讓您使用最快的方式搜尋某一個標籤的所有商店商品。比方說點選「紅色」這個標籤，就可以開啟這樣的一個頁面，顯示所有的以「紅色」 為標籤的商店商品';
...
$_LANG['promotion_time'] = '的時間為 %s 到 %s，趕快來搶吧！';
